...
L["S_TOOLTIP_WARBAND_REP_BONUS"] = "Awards a one-time Warband reputation bonus"
...
L["S_OPTIONS_TRACKER_ATTACH_TO_KALIEL"] = "Attach below Kaliel's Tracker"
L["S_OPTIONS_WORLDMAP_ORGANIZEBY"] = "Organize Quests By"
L["S_OPTIONS_WORLDMAP_ANCHOR_TO"] = "Attach To"
L["S_OPTIONS_WORLDMAP_SHOW_TRANSMOG_STATUS"] = "Show Transmog Status"
L["S_OPTIONS_WORLDMAP_SHOW_TRANSMOG_STATUS_DESC"] = "Shows a green check or red x on the top right of each quest reward icon, marking whether you've already collected that item's transmog appearance."
